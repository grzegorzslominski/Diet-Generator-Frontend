...
export const TableItem = styled.div<prop>`
    ...
    img {
        ...
        ${({ isOpen }) =>
            isOpen
                ? css`
                      filter: invert(62%) sepia(94%) saturate(3584%) hue-rotate(85deg)
                          brightness(119%) contrast(126%);
                  `
                : css`
                      filter: invert(18%) sepia(94%) saturate(6357%) hue-rotate(2deg)
                          brightness(91%) contrast(125%);
                  `}
    }
`;
